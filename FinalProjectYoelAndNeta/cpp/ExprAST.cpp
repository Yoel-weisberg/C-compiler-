...
Value* IfExprAST::codegen() 
{
    ...
    {
        // Add as new scope 
        Helper::_symbolTable.addScope(ELSE_SCOPE);
...
{
    // Add as new scope 
    Helper::_symbolTable.addScope(WHILE_SCOPE);
...
llvm::Value* ReturnStatementExprAST::codegen()
{
    // Assuming return type is an integer
    return nullptr;
}
